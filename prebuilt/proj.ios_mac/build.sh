...
compress $OSX_DEBUG_PREBUILT_LIBS_DIR $MAC_COMPRESSED_LIBS_DIR/libcocos2d-x-debug.7z
compress $OSX_RELEASE_PREBUILT_LIBS_DIR $MAC_COMPRESSED_LIBS_DIR/libcocos2d-x-release.7z